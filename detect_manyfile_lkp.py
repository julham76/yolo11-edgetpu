...
for image_path in image_files:
    ...
    for r in results:
        for box in r.boxes:
            ...
            r.save(filename='/home/pi/yolo-edgetpu/result_jpg/detection'+str(i)+'.jpg')
            # Save to a CSV file
            df = pd.DataFrame(all_detections)
            df.to_csv('/home/pi/yolo-edgetpu/result_jpg/detections'+str(i)+'.csv', index=False)
            df.to_json('/home/pi/yolo-edgetpu/result_jpg/detections'+str(i)+'.json', index=False)
